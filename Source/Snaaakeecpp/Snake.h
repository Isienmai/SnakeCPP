...
class Snake
{
	...
	//Stores the last combination of directional keys, and the current size of the snake (used for scoring purposes).
	int lastInput, snakeLength;
...
public:
	...
	//Returns the coordinate of the snakes tail and then removes the tail from the snake.
	Coord RemoveTail();
